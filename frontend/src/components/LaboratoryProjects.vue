  ...
  >
    ...
    <div class="solutions-grid-container">
      <div 
        ...
        :class="{ 'blur-this': selectedSolution }"
      >
        <div 
...
import ThreeDSolution from './solutions/ThreeDSolution.vue';
...
const solutions = ref([
  ...
  },
  {
    ...
    type: "threeD",
    shortDesc: "3D physics simulation platform",
    fullDesc: "A powerful 3D simulation engine designed for scientific visualization and interactive modeling. Supports real-time physics calculations, particle systems, and complex fluid dynamics with high-performance rendering capabilities.",
...
const getSolutionComponent = (type) => {
  switch (type) {
    ...
    case 'threeD': return ThreeDSolution;
